...
document.addEventListener('DOMContentLoaded', function () {
    if (document.querySelector('.testimonal-inner .swiper-container')) {
        new Swiper('.testimonal-inner .swiper-container', {
            loop: true,
            slidesPerView: 1,
            speed: 1000,
            navigation: {
                nextEl: '.testimonal-inner .next-paginate',
                prevEl: '.testimonal-inner .prev-paginate'
            }
        });
    }
});
